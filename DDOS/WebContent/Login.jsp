      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-info" style="margin-left: -150px;border-top-color: brown;">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="loginform" method="post" action="LoginUser1" id="actionForm">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Username</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username"  required="required" placeholder="Email">
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                 ...
                 <a href="ForgotServlet" style="color: brown;">Forgot your password?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 
                 <button type="button" class="btn btn-info test" style="background-color: brown;" onclick="getLocation();">Sign in</button> &nbsp;&nbsp;&nbsp;&nbsp;
                 
						<a href="Registration.jsp" style="color: brown;">Registration for New User</a>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
