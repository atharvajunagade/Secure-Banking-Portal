...
<%@page import="com.model.Account"%>
    ...
    %>
     ...
     try
     {
        String accountnumber = request.getSession().getAttribute("accountno").toString(); // Accessing the account number from session.
     }
     catch(Exception e)
     {
    	// request.getRequestDispatcher("Error.jsp?msg=You are not logged in user....please Login here <a href=Login.jsp>click</a>").forward(request,response);
     }
    %>
 <%
 DB db = new DB();
			  ...
			  <div id="right">
				...
				<div class="field">
					<table>
						...
						<td>1234567898 / 5874596456</td>
						</tr>
						<tr>
						<br>
						<th><br></>Address</th>
						<td><b>ABC Bank,</b><br>
							4th Floor Sonawane Complex,<br>
							Balaji Nagar,<br>
							Satara Road,Pune-43.							
						</td>
						</tr>	
