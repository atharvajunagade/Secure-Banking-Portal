			...
			<div id="right">
				...
				<div class="box">
					<!-- box / title -->
							...
							<div class="container">
						   <form action="SearchCustomerRecords" method="post">
							<div class="form">					
						<div class="fields">
							<div class="field">
								<div class="label">
									<label for="fullname">Enter Customer Name</label>
								</div>
								<div class="input">
									<input type="text" id="fullname" name="fullname" size="40" value="" class="focus">
								</div>
							</div>	
							</div><br>
