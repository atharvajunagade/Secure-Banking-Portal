...
public class LoginUser1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		boolean user = SQLinjection.check(username);
	 	boolean pass = SQLinjection.check(password);
		...
		/*else 
		{
			...
			s.setAttribute("msg", "Username or password wrong");
			System.out.println("fdgfdfg :: " + session.getAttribute("msg"));
