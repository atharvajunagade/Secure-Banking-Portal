		...
		<div id="content">
			...
			<!-- content / right -->
			  ...
			  <div id="right">
				...
				<div class="form">
					<div class="field">
						<h4 align="center" style="font-style: normal">Your Fund has been transferred successfully</h4><br><br>
						</div>
						<div class="field">
						<table>					
						<tr>
						...
						<tr>
						<td align="center" style="font-weight: bold"><%=request.getParameter("benificiary_name")%>
						</td>
						<td align="center" style="font-weight: bold"><%=request.getParameter("raccountno")%>
						</td>
						<td align="center" style="font-weight: bold"><%=request.getParameter("transAmount")%>
						</td>					
						</tr>	
						</table>
						</div>
